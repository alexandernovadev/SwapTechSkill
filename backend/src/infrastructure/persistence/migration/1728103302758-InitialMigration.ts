...
export class InitialMigration1728103302758 implements MigrationInterface {
    name = 'InitialMigration1728103302758'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Chats" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "status" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_64c36c2b8d86a0d5de4cf64de8d" PRIMARY KEY ("id"))`);
