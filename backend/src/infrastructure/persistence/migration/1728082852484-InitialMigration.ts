...
export class InitialMigration1728082852484 implements MigrationInterface {
    name = 'InitialMigration1728082852484'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Ratings" ("id" SERIAL NOT NULL, "rate" numeric(2,1) NOT NULL DEFAULT '0', "message" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee6436ff188c9bb00cc70fc447a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Meetings" ("id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "description" text, "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, "zoom_link" character varying(255), "status" character varying(50) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "organizerId" integer, CONSTRAINT "PK_b6bef0e8c793f404cfb5af9493d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Notifications" ADD CONSTRAINT "FK_28a9de2f34e218f2ccc746ed4f7" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "UserRatings" ADD CONSTRAINT "FK_fe0005f64176ef1a1cb1bc06015" FOREIGN KEY ("raterId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "UserRatings" ADD CONSTRAINT "FK_bf353b8c98695e73c9f2aed417f" FOREIGN KEY ("rateeId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "UserRatings" DROP CONSTRAINT "FK_bf353b8c98695e73c9f2aed417f"`);
        await queryRunner.query(`ALTER TABLE "UserRatings" DROP CONSTRAINT "FK_fe0005f64176ef1a1cb1bc06015"`);
        ...
        await queryRunner.query(`DROP TABLE "UserRatings"`);
        await queryRunner.query(`DROP TABLE "Notifications"`);
        await queryRunner.query(`DROP TABLE "MeetingParticipants"`);
